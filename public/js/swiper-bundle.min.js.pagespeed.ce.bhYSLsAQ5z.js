...
var Swiper = (function () {
  ...
  var D = {
      ...
      for (let i = 0; i < p; i += 1) {
        ...
        if (
          ...
          if ('auto' === s.slidesPerView) {
            ...
            ((P = (r - (s.slidesPerView - 1) * E) / s.slidesPerView),
              s.roundLengths && (P = Math.floor(P)),
    ...
    updateActiveIndex: function (e) {
      ...
      if ((o >= i.length && (o = i.length - 1), d === r && !t.params.loop))
        return void (o !== n && ((t.snapIndex = o), t.emit('snapIndexChange')));
    ...
    translateTo: function (e, t, s, i, a) {
      ...
      if (
        ...
        if (0 === t) n[e ? 'scrollLeft' : 'scrollTop'] = -c;
          ...
          n.scrollTo({ [e ? 'left' : 'top']: -c, behavior: 'smooth' });
        }
        return !0;
      }
      return (
    ...
    slideTo: function (e, t, s, i, a) {
      ...
      if (
        ...
        return (
          ...
          'slide' !== n.effect && r.setTranslate(b),
    ...
    slideToLoop: function (e, t, s, i) {
      ...
      if (a.params.loop)
        if (a.virtual && a.params.virtual.enabled) l += a.virtual.slidesBefore;
          ...
          'auto' === n
            ? (n = a.slidesPerViewDynamic())
            : ((n = Math.ceil(parseFloat(a.params.slidesPerView, 10))),
              s && n % 2 == 0 && (n += 1));
          let o = t - e < n;
          if (
            (s && (o = o || e < Math.ceil(n / 2)),
  ...
  var B = {
    ...
    loopFix: function (e) {
      ...
      const L = w ? Math.ceil(d.length / m.grid.rows) : d.length,
        P = (w ? d[r].column : r) + (f && void 0 === a ? -v / 2 + 0.5 : 0);
      if (P < b) {
        C = Math.max(b - P, g);
  ...
  function F(e) {
    ...
    let b = !0;
    (p.matches(l.focusableElements) &&
      ((b = !1), 'SELECT' === p.nodeName && (l.isTouched = !1)),
      s.activeElement &&
  ...
  function V(e) {
    ...
    (r.oneWayMovement &&
      ((v = Math.abs(v) * (n ? 1 : -1)), (g = Math.abs(g) * (n ? 1 : -1))),
      (l.diff = v),
      (v *= r.touchRatio),
      n && ((v = -v), (g = -g)));
  ...
  function H(e) {
    ...
    for (
      ...
      void 0 !== c[e + t]
        ? (h || (f >= c[e] && f < c[e + t])) && ((v = e), (g = c[e + t] - c[e]))
        : (h || f >= c[e]) &&
    ...
    r.rewind &&
      (t.isBeginning
        ...
        : t.isEnd && (b = 0));
    const y = (f - c[v]) / g,
      S = v < r.slidesPerGroupSkip - 1 ? 1 : r.slidesPerGroup;
    if (m > r.longSwipesMs) {
      if (!r.longSwipes) return void t.slideTo(t.activeIndex);
      ('next' === t.swipeDirection &&
        (y >= r.longSwipesRatio
          ? t.slideTo(r.rewind && t.isEnd ? b : v + S)
          : t.slideTo(v)),
      ...
      (a.target === t.navigation.nextEl || a.target === t.navigation.prevEl)
        ? a.target === t.navigation.nextEl
          ? t.slideTo(v + S)
          : t.slideTo(v)
        : ('next' === t.swipeDirection && t.slideTo(null !== b ? b : v + S),
  ...
  const Q = {
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const f = n.direction && n.direction !== i.direction,
            h = i.loop && (n.slidesPerView !== i.slidesPerView || f),
            v = i.loop;
          (f && s && e.changeDirection(), p(e.params, n));
  ...
  class ee {
    constructor() {
      ...
      ((n.__swiper__ = !0),
        (n.support = M()),
        (n.device = L({ userAgent: t.userAgent })),
        (n.browser = P()),
        (n.eventsListeners = {}),
    ...
    slidesPerViewDynamic(e, t) {
      ...
      if (s.centeredSlides) {
        let e,
          t = i[n] ? Math.ceil(i[n].swiperSlideSize) : 0;
    ...
    function (e) {
      ...
      function c(e, t) {
        ...
        const { addSlidesBefore: c, addSlidesAfter: p } = s.params.virtual,
          { from: u, to: m, slides: h, slidesGrid: v, offset: g } = s.virtual;
        s.params.cssMode || s.updateActiveIndex();
        const b = s.activeIndex || 0;
        let w, y, S;
        ((w = s.rtlTranslate ? 'right' : s.isHorizontal() ? 'left' : 'top'),
          r
            ? ((y = Math.floor(i / 2) + a + p), (S = Math.floor(i / 2) + a + c))
            : ((y = i + (a - 1) + p), (S = (n ? i : a) + c)));
        let T = b - S,
          E = b + y;
        n || ((T = Math.max(T, 0)), (E = Math.min(E, h.length - 1)));
        let x = (s.slidesGrid[T] || 0) - (s.slidesGrid[0] || 0);
        function C() {
          (s.updateSlides(),
            s.updateProgress(),
            s.updateSlidesClasses(),
        ...
        if (
          (n && b >= S
            ? ((T -= S), r || (x += s.slidesGrid[0]))
            : n && b < S && ((T = -S), r && (x += s.slidesGrid[0])),
        ...
        if (s.params.virtual.renderExternal)
          return (
            s.params.virtual.renderExternal.call(s, {
              ...
              slides: (function () {
                const e = [];
                for (let t = T; t <= E; t += 1) e.push(h[t]);
                return e;
              })(),
            }),
        ...
        const k = n ? -h.length : 0,
          I = n ? 2 * h.length : h.length;
        for (let t = k; t < I; t += 1)
          if (t >= T && t <= E) {
            const s = P(t);
            void 0 === m || e
              ? L.push(s)
              : (t > m && L.push(s), t < u && M.push(s));
          }
        if (
          (L.forEach((e) => {
    ...
    function (e) {
      ...
      function p() {
        ...
        if (
          ...
          if (
            (s.dynamicBullets &&
              ((l = S(a[0], t.isHorizontal() ? 'width' : 'height', !0)),
              c.forEach((e) => {
        ...
        c.forEach((e, r) => {
          if (
            ...
            let l = 1,
              n = 1;
            ('horizontal' === a ? (l = r) : (n = r),
              e.querySelectorAll(se(s.progressbarFillClass)).forEach((e) => {
                ((e.style.transform = `translate3d(0,0,0) scaleX(${l}) scaleY(${n})`),
    ...
    function (e) {
      ...
      function y(e) {
        a &&
          ...
          (a.wrapperEl.removeEventListener('transitionend', y), v || M());
      }
      const S = () => {
        ...
        P = (e) => {
          'mouse' === e.pointerType &&
            ((h = !0), (v = !0), a.animating || a.autoplay.paused || C(!0));
        },
        k = (e) => {
      ...
      (l('init', () => {
        ...
        l('beforeTransitionStart', (e, t, s) => {
          !a.destroyed &&
            a.autoplay.running &&
            (s || !a.params.autoplay.disableOnInteraction ? C(!0, !0) : x());
        }),
        l('sliderFirstMove', () => {
          !a.destroyed &&
            a.autoplay.running &&
        ...
        Object.assign(a.autoplay, { start: E, stop: x, pause: C, resume: M }));
    },
  ];
  return (ee.use(ie), ee);
})();
